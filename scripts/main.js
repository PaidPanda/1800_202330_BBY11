...
function displayCardsDynamically(collection) {
    let cardTemplate = document.getElementById("lotCardTemplate"); // Retrieve the HTML element with the ID "hikeCardTemplate" and store it in the cardTemplate variable. 
