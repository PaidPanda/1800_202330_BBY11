...
const parkingLots = {
    ...
    'Parking Lot Q': { lat: 49.25113627947013, lon: -123.00334181473046 }
...
//         if (user) {
//           if (confirm(`You are within 200m of ${closestLot}. Would you like to provide input for this parking lot?`)) {
//             recordUserInput(user, closestLot);
//             window.location.href = '2.userinput.html'; // Redirect if user agrees
//           }
//         } else {
...
//   // Function to record user input in Firebase
//   function recordUserInput(user, parkingLotName) {
//     const lotIdMapping = {
//         'Parking Lot A': 'LoNPtlttHuemMG8tcrEa',
//         'Parking Lot B': 'Xe5qgMGL64JCj7WGMFJq',
//         'Parking Lot D': 'nk9lY3Qp0HpFIyYTNd2z',
//         'Parking Lot E': 'zfVvfns1zPL8e0DpR0rr',
//         'Parking Lot F': 'wMrrF3qCzBlnX53eTY9V',
//         'Parking Lot N': 'kwTu1BeBHlc3gS5oDlTC',
//         'Parking Lot Q': 'PCh72yAvXUEyTFCz10zZ'
//     };
  
//     db.collection("userInputs").add({
//       userId: user.uid,
//       choice: parkingLotName,
//       lotId: lotIdMapping[parkingLotName]
//     })
//     .then((docRef) => {
